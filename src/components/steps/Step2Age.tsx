...
import { Calendar, Clock, HelpCircle, ArrowLeft } from 'lucide-react';
...
export default function Step2Age({ data, onNext, onBack }: Step2Props) {
  const options = [
    { value: 'Unter 10 Jahre', label: 'Unter 10 Jahre', desc: 'Relativ modern' },
    { value: '10-15 Jahre', label: '10–15 Jahre', desc: 'Mittleres Alter' },
    { value: '15-20 Jahre', label: '15–20 Jahre', desc: 'Austausch wird empfohlen' },
    { value: '20-25 Jahre', label: '20–25 Jahre', desc: 'Austausch dringend ratsam' },
    { value: 'Älter als 25 Jahre', label: 'Über 25 Jahre', desc: 'Gesetzliche Austauschpflicht droht' },
    { value: 'Weiß nicht', label: 'Weiß nicht genau', desc: 'Schätzung reicht aus' },
  ];
